...
typedef enum {
    ...
    PKT_LOGIN_REQ  , PKT_LOGIN_RES,
    PKT_DIR_REQ    , PKT_DIR_RES,
    PKT_FOPEN_REQ  , PKT_FOPEN_RES,
    PKT_EDIT_REQ   , PKT_SYNC_REQ,
    PKT_SYNC_RES   , PKT_FLUSH_REQ,
    PKT_FLUSH_RES  ,
    PKT_USERS_REQ  , PKT_USERS_RES,
    PKT_ADDUSER_REQ, PKT_ADDUSER_RES,
    PKT_RMUSER_REQ , PKT_RMUSER_RES,
    PKT_CHPSWD_REQ , PKT_CHPSWD_RES,
    PKT_MKFILE_REQ , PKT_MKFILE_RES,
    PKT_FLINK_REQ  , PKT_FLINK_RES,
    PKT_TERM,
